...
CREATE TABLE tb_Seguidor(
	...
	,FOREIGN KEY (id_Usuario_Seguido) REFERENCES tb_Seguidor(id)
	,FOREIGN KEY (id_Usuario_Seguidor) REFERENCES tb_Seguidor(id)
);
GO
ALTER TABLE tb_Usuario
ALTER COLUMN FotoPerfilUrl NVARCHAR(255) NOT NULL;
